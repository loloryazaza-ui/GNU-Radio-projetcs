In this project an Amplitude modulation transmitter and receuver was made.
As an audio file it can use *.mp3 or *.wav files.
Originally, I tested it with *.mp3 file. 
I tested it with HackRF One in a laboratorial conditions with parameters:
