...
class RTL_FM_radio(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "RTL_FM_radio")
        ...
        self._channel_options = [87500000, 100500000, 104400000, 106300000, 90100000]
        ...
        self.qtgui_freq_sink_x_2 = qtgui.freq_sink_c(
            ...
            0, #fc
            samp_rate, #bw
            "RX signal after Low Pass Filter", #name
            1,
            None # parent
        )
        ...
        self.qtgui_freq_sink_x_1 = qtgui.freq_sink_f(
            ...
            0, #fc
            samp_rate, #bw
            "RX_signal after WBFM Receive", #name
            1,
            None # parent
        )
        ...
        self.qtgui_freq_sink_x_0 = qtgui.freq_sink_f(
            ...
            0, #fc
            samp_rate, #bw
            "RX_sig after rational resampler", #name
            1,
            None # parent
        )
...
def main(top_block_cls=RTL_FM_radio, options=None):
